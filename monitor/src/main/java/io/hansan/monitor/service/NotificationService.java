package io.hansan.monitor.service;
    ...
    public class NotificationService extends ServiceImpl<NotificationMapper, NotificationModel> {
         ...
         * 发送邮件通知
         */
        private void sendEmailNotification(NotificationModel notification, String message) {
            // 实现邮件发送逻辑
        }
         ...
         * 发送Webhook通知
         */
        private void sendWebhookNotification(NotificationModel notification, String message) {
            // 实现Webhook通知逻辑
        }
    }