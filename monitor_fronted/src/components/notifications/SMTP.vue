...
<!--        </div>-->
        ...
        <div class="mb-3">
            ...
            <input id="to-email" v-model="$parent.notification.email" type="text" class="form-control" autocomplete="false" placeholder="example2@uptime.monitor, example3@uptime.monitor" :required="!hasRecipient">
        </div>
...
<!--        </ToggleSection>-->
        ...
        <div class="mb-3">
            ...
            <input id="subject-email" v-model="$parent.notification.subject" type="text" class="form-control" autocomplete="false" placeholder="">
